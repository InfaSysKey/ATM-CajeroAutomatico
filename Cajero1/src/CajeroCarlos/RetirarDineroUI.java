 ...
 * 
 */
public class RetirarDineroUI extends javax.swing.JPanel implements ActionListener {
    ...
    /**
     * Creates new form RetirarDineroUI
     *
     * @param usuario
     * @param tarjeta
     * @param cuenta
     */
    public RetirarDineroUI(Usuario usuario, Tarjeta tarjeta, Cuenta cuenta) {
        initComponents();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == botonNumero1 || e.getSource() == botonNumero2 || e.getSource() == botonNumero3 || e.getSource() == botonNumero4
            ...
            String dinero = txtRetirar.getText();
            if (e.getSource() == botonNumero0) {
                dinero += "0";
                txtRetirar.setText(dinero);
            }
    ...
    private void initComponents() {
        ...
        txtRetirar.setBackground(new java.awt.Color(108, 122, 137));
        txtRetirar.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtRetirar.setForeground(new java.awt.Color(228, 241, 254));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtRetirar, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)))
     ...
     * a una consulta para retirar dinero de la cuenta.
     * 
     */
    private void botonAccionEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAccionEnterActionPerformed
        ...
        if (dineroCajero > 0) {
            try {
                ...
                if (dineroCajero <= cantidad) {
                    JOptionPane.showMessageDialog(pantallaPrincipal, "No hay suficiente dinero en el cajero", "Advetencia", JOptionPane.WARNING_MESSAGE);
                } else {
                    if (cuenta.getSaldo() > 0 && cuenta.getSaldo() > cantidad) {
                        System.out.println(usuario.getNombre());
                        cuenta.setSaldo(cuenta.getSaldo() - cantidad);
                        dineroCajero = dineroCajero - cantidad;
                        ServicioBBDD.actualizaSaldoRetirar(cuenta);
                        ServicioBBDD.insertaMovimientoRetirada(cuenta, cantidad, tarjeta);
                        ServicioBBDD.updateCajero(dineroCajero);

                    } else {
                        JOptionPane.showMessageDialog(pantallaPrincipal, "Saldo insuficiente, pongase en contacto con el banco", "Advertencia", JOptionPane.WARNING_MESSAGE);
                    }
                }

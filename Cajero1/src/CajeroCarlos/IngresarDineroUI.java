 ...
 * 
 */
public class IngresarDineroUI extends javax.swing.JPanel implements ActionListener {
    ...
    /**
     * Creates new form IngresarDineroUI
     */
    public IngresarDineroUI(Usuario usuario, Tarjeta tarjeta, Cuenta cuenta) {
        initComponents();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == botonNumero1 || e.getSource() == botonNumero2 || e.getSource() == botonNumero3 || e.getSource() == botonNumero4
                || e.getSource() == botonNumero5 || e.getSource() == botonNumero6 || e.getSource() == botonNumero7
                || e.getSource() == botonNumero8 || e.getSource() == botonNumero9 || e.getSource() == botonNumero0 || e.getSource() == botonLimpiar || e.getSource() == botonCancelar) {
            String dinero = txtIngresas.getText();
            if (e.getSource() == botonNumero0) {
                dinero += "0";
                txtIngresas.setText(dinero);
            }
    ...
    private void initComponents() {
        ...
        txtIngresas = new javax.swing.JTextField();
        ...
        txtIngresas.setBackground(new java.awt.Color(108, 122, 137));
        txtIngresas.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtIngresas.setForeground(new java.awt.Color(228, 241, 254));
        txtIngresas.setHorizontalAlignment(javax.swing.JTextField.CENTER);
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtIngresas, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(129, 129, 129)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtIngresas, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(55, 55, 55)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(botonAccionEnter)
     ...
     * a una consulta para ingresar dineroe en la cuenta.
     * 
     */
    private void botonAccionEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAccionEnterActionPerformed
        ...
        System.out.println(cuenta.getIdUsuario());
        int dineroCajero = ServicioBBDD.totalDinero();
        System.out.println(dineroCajero);
        try {
            int cantidad = Integer.parseInt(txtIngresas.getText());
             System.out.println(usuario.getNombre());
             cuenta.setSaldo(cuenta.getSaldo() + cantidad);
             dineroCajero = dineroCajero + cantidad;
             ServicioBBDD.actualizaSaldoIngresa(cuenta);
             ServicioBBDD.insertaMovimientoIngreso(cuenta, cantidad, tarjeta);
             ServicioBBDD.updateCajero(dineroCajero);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(pantallaPrincipal, "Unicamente numeros enteros", "Advetencia", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public javax.swing.JTextField txtIngresas;
